// navbar dengan 3 kolom. kolom pertama berisi logo, kolom kedua berisi navigasi ke page about dan prices dan dibawahnya terdapat tulisan copyright, kolom ketigas berisi 2 logo yang isinya logo facebook dan twitter
        ...
        <nav className="bg-white">
            <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
                ...
                <div className="flex justtify-center">
                    <div className="flex items-center justify-between">
                        <Link to="/">
                            <img src="src\assets\Gambar\fb.png" alt="Neuverse" />
                        </Link>
                        <Link to="/">
                            <img src="src\assets\Gambar\twiter.png" alt="Neuverse" />
                        </Link>
                    </div>
                </div>
            </div>
